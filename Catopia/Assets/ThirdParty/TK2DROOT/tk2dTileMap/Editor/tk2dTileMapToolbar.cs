...
public static class tk2dTileMapToolbar
{
	...
	public static void ToolbarWindow() {
		...
		if (HiliteBtn(tk2dEditorSkin.GetTexture("icon_pencil"), (mainMode == MainMode.BrushLand), tk2dPreferences.inst.tileMapToolColor_brush_land, "Draw Land")) mainMode = MainMode.BrushLand;
		GUILayout.Space(10);

		if (HiliteBtn(tk2dEditorSkin.GetTexture("icon_pencil"), (mainMode == MainMode.BrushTower), tk2dPreferences.inst.tileMapToolColor_brush_tower, "Draw Tower")) mainMode = MainMode.BrushTower;
		GUILayout.Space(10);

		if (HiliteBtn(tk2dEditorSkin.GetTexture("icon_pencil"), (mainMode == MainMode.BrushMonster), tk2dPreferences.inst.tileMapToolColor_brush_monster, "Draw Monster")) mainMode = MainMode.BrushMonster;
		GUILayout.Space(20);
