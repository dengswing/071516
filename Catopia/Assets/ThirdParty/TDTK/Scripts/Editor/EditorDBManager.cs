...
namespace TDTK {
	...
	public class EditorDBManager : EditorWindow {
		...
		public static void AddTowerNewID(UnitTower tower, int newID)
		{
			if (IsOKNewID(towerIDList, newID))
			{
				int oldID = tower.prefabID;
				tower.prefabID = newID;
				towerIDList.Remove(oldID);
				towerIDList.Add(newID);
			}
        }
		...
		public static void AddCreepNewID(UnitCreep creep, int newID)
		{
			if (IsOKNewID(creepIDList, newID))
			{
				int oldID = creep.prefabID;
				creep.prefabID = newID;
				creepIDList.Remove(oldID);
				creepIDList.Add(newID);
			}
		}
		...
		private static bool IsOKNewID(List<int> list, int id)
		{
