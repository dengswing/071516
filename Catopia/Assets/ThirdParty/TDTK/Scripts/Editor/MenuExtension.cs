...
namespace TDTK {
	...
	public class MenuExtension : EditorWindow {
		...
		[MenuItem("Dora/炮塔制作", false, 200)]
		static void OpenTowerMaker()
		{
			MakeTowerEditorWindow.Init();
		}

		[MenuItem("Dora/怪物制作", false, 200)]
		static void OpenCreepMaker()
		{
			MakeCreepEditorWindow.Init();
		}

		[MenuItem("Dora/子弹制作", false, 200)]
		static void OpenShootMaker()
		{
			MakeShootEditorWindow.Init();
		}

		[MenuItem("Dora/场景制作", false, 200)]
		static void OpenSceneMaker()
		{
			MakeSceneEditorWindow.Init();
		}
