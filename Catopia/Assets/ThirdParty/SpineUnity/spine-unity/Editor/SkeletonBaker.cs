...
using System.IO;
using Spine;
using AnimationClipSettings = UnityEditor.AnimationClipSettings;
...
public static class SkeletonBaker {
	...
	static void SetAnimationSettings (AnimationClip clip, UnityEditor.AnimationClipSettings settings) {
#if UNITY_5
